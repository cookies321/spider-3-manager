...
public class Flightinfo implements Serializable{
    ...
    public void setRealcosttime(String realcosttime) {
        this.realcosttime = realcosttime == null ? null : realcosttime.trim();
    }
    ...
    public void setBeginterminal(String beginterminal) {
        this.beginterminal = beginterminal == null ? null : beginterminal.trim();
    }
